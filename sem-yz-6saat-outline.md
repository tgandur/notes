```thalo
2026-01-28T18:25Z create lore "SEM-YZ Kompakt Program (6 Saat)" ^lore-sem-yz-6saat #workshop #ai
  type: "fact"
  subject: ^project-sem-yz

  # Description
  SEM-YZ Sertifika Programı'nın yoğunlaştırılmış, uygulama içermeyen versiyonu. Tek günde tamamlanır.

  **Program Karşılaştırması:**

  | Özellik | Tam Program | Kompakt Program |
  |---------|-------------|-----------------|
