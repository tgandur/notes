```thalo
2026-01-28T18:25Z create lore "SEM-YZ Kompakt: Kurumsal İçerik" ^lore-sem-yz-6saat-icerik #workshop #ai #sem
  type: "fact"
...
- Yapay zekaya giriş yapmak isteyen profesyoneller
- Kurumsal farkındalık eğitimi katılımcıları
- Zaman kısıtı olan bireyler
...
1. Yapay zeka sistemlerinin temel çalışma prensiplerini açıklayabilir
2. 4T Modeli'ni (Teslim Et, Tarif Et, Tetkik Et, Titizlen) tanımlayabilir
3. BAŞTAF prompt çerçevesini kullanarak etkili talepler oluşturabilir
4. YZ çıktılarını eleştirel değerlendirebilir
5. Etik ve güvenlik konularında farkındalık kazanır
...
### Modül 6: Entegrasyon ve Kapanış (60 dk)

**Amaç:** Öğrenilenleri bütünleştirmek

- 4T Döngüsü: Pratikte nasıl uygulanır?
- Kaynak paketi ve sonraki adımlar
- Soru-cevap

**Kaynak:** Tam program (24 saat) bilgilendirmesi

---

## Değerlendirme

Bu kompakt programda formal değerlendirme yapılmaz. Katılım sertifikası verilir.

**Not:** Yetkinlik sertifikası almak isteyenler 24 saatlik tam programa yönlendirilir.
...
> 4T Modeli, Anthropic'in "4D Framework for AI Fluency" çerçevesinden Türkçeye adapte edilmiştir.
> © 2025 Rick Dakan, Joseph Feller, and Anthropic. Lisans: CC BY-NC-SA 4.0
