```thalo
2026-01-28T18:11Z define-synthesis "SEM-YZ Proje Özeti" ^synthesis-sem-yz-summary
  sources: lore where ^project-sem-yz

  # Prompt
  Bu projeye bağlı tüm lore'ları kullanarak, SEM-YZ (Sağlık Profesyonelleri için
  Yapay Zeka Sertifika Programı) hakkında kapsamlı bir özet yaz.

  Şunları içersin:
  - Programın amacı ve hedef kitlesi
  - 4T Modeli ve bileşenleri
  - Prompt teknikleri ve BAŞTAF çerçevesi
  - Modül yapısı

  Özet profesyonel ve bilgilendirici olsun, 2-3 paragraf.

2026-01-28T18:14Z actualize-synthesis ^synthesis-sem-yz-summary
